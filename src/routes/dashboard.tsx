    ...
    <div className="min-h-screen bg-[#0B1E2D] text-white flex flex-col md:flex-row">
      ...
      <main className="flex-1 p-6 md:p-10">
        <header className="flex items-center justify-between gap-4 flex-wrap">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold">Hola, {user.name} 👋</h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-10 h-10 rounded-full bg-gradient-brand text-[#0B1E2D] flex items-center justify-center font-bold">
